...
import org.example.springbootdeveloper.dto.StudentDto; // import 받아오는 이유 - 패키지 달라짐
import org.example.springbootdeveloper.service.StudentService; // import 받아오는 이유 - 패키지 달라짐
...
// @RestController
// : @Controller + @ResponseBody 가 결합된 애너테이션
...
public class StudentController {
    ...
    // 비즈니스 로직을 처리하는 Service 객체를 주입받아 사용 (final은 원래 선언과 동시에 초기화 해야하는데 주입 받을 거라 선언만 함)
    ...
    public StudentDto getStudentById(@PathVariable Long id) {
        // @PathVarialbe: URL 경로에 전달된 id값을 메서드 파라미터로 매핑
