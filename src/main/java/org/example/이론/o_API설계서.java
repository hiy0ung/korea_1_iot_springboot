...
public class o_API설계서 {
    /*
        ...
        - code/string/0
         /결과에 대한 코드
         (성공: SU, 요청 메개변수 검증 실패: VF, 존재하는 회원 이메일: EU
         , 존재하는 회원 닉네임: EN, 존재하는 회원 핸드폰 번호: EP, 데이터베이스 오류: DE)
        - message: 결과에 대한 메시지(영어로 작성 EX) Success, Request Parameter Validation Failde)
        - 데이터
    */
}
